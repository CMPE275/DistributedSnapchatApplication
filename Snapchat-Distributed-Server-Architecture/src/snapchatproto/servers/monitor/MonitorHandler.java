 ...
 * 
 */
public class MonitorHandler extends SimpleChannelInboundHandler<ServerCommunicationMessage> {
	 ...
	 */
	@Override
	protected void channelRead0(ChannelHandlerContext ctx, ServerCommunicationMessage msg) throws Exception {
