...
public class ConnectionManager {
	...
	public synchronized static void broadcast2(Request req) {
		if (req == null)
			return;
	...
	public synchronized static void broadcast(ServerCommunicationMessage mgmt) {
		if (mgmt == null)
			return;
		logger.info("The management connections are "+mgmtConnections.size());
