...
import snapchatproto.servers.monitor.MonitorListener;
...
public class HeartbeatStubListener implements MonitorListener {
	 ...
	 */
	@Override
	public void onMessage(ServerCommunicationMessage msg, ChannelHandlerContext ctx) {
		if (logger.isDebugEnabled())
			logger.debug("HB from node " + msg.getRaftHeader().getOriginatorNodeId());
