...
//
//import snapchatproto.core.Mgmt.LeaderElection;
//import snapchatproto.core.Mgmt.LeaderElection.ElectAction;
//import snapchatproto.core.Mgmt.Management;
//import snapchatproto.core.Mgmt.MgmtHeader;
//import snapchatproto.core.Mgmt.VectorClock;
//import snapchatproto.servers.managers.NodeDataManager;
//import snapchatproto.servers.managers.RaftNode;
//import snapchatproto.servers.managers.NodeData.RaftStatus;
//import snapchatproto.servers.managers.RaftNode.NodeState;
////import snapchatproto.servers.election.RaftElection.RState;
//
//
///**
...
//			if(count >= 2)
//			{
//				//System.out.println("Before Declaring Winner " + this.currentState );
//				rtn = sendLeaderMesssage(mgmt, isNew);
//				NodeDataManager.getInstance().getNodeData().setNodeStatus(RaftStatus.LEADER);
//				//System.out.println("After Declaring Winner " + this.currentState );
//				notify(true, req.getCandidateId());
//			}
//		}  else {
//			// this is me!
...
//	
//	//////// Vishwa
//	private Management sendLeaderMesssage(Management mgmt, boolean isNew) {
//		if (!mgmt.hasElection())
//			return null;
//
//		if (current == null || !current.isActive()) {
