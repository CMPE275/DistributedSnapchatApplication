 ...
 * under the License.
 */
package snapchatproto.servers.resources;
...
import snapchatproto.servers.conf.ServerConf.ResourceConf;
...
public class ResourceFactory {
	...
	private static ClusterConfList sCfg;
	...
	public static void initializeCluster(ClusterConfList cfg) {
		try {
			ResourceFactory.sCfg = cfg;
			factory.compareAndSet(null, new ResourceFactory());
		} catch (Exception e) {
			logger.error("failed to initialize ResourceFactory", e);
		}
