 ...
 * 
 */
public class ManagementHandler extends SimpleChannelInboundHandler<ServerCommunicationMessage> {
	...
	@Override
	public void channelRead0(ChannelHandlerContext ctx, ServerCommunicationMessage req) throws Exception {
		...
		logger.info("---> management got a message from " + req.getRaftHeader().getOriginatorNodeId());
