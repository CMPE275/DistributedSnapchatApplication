...
public class ManagementQueue {
	...
	public static void enqueueRequest(ServerCommunicationMessage req, Channel ch) {
		try {
	...
	public static void enqueueResponse(ServerCommunicationMessage reply, Channel ch) {
		try {
	...
	public static class ManagementQueueEntry {
		public ManagementQueueEntry(ServerCommunicationMessage req, Channel ch) {
			this.req = req;
			this.channel = ch;
		}

		public ServerCommunicationMessage req;
